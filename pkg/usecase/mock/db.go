...
func (m *MockDB) GetArticles(ctx context.Context, cursorPublishedAt int64, cursorTitle string, order usecase.CursorOrder, n int, articles *[]entity.Article) error {
	m.ctrl.T.Helper()
